...
testing_folder = {'model':UNet3D(),
                       'device': torch.device("cuda:0" if torch.cuda.is_available() else "cpu"),
                       'model_path': "/home/liliana/models/testfolder_Model/brain_mask_from_0_to_24_fold_1.pt",
                       'path_to_save_segm':"/home/liliana/Results/UNetFullDataset/Fold2/",
                       'path_to_save_metrics': "/home/liliana/Results/UNetFullDataset/Fold2/"}
...
cases_to_validate = "/home/liliana/dataToValidate/Unet100Cases_Data/cases_val_fold_2.txt"
