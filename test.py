...
testing_folder = {'model':UNet3D,
                       'device': torch.device("cuda:0" if torch.cuda.is_available() else "cpu"),
                       'model_path': "/home/liliana/models/UNetUniformSampling32_Model/UNetUniformSampling32_from_0_to_24_fold_1.pt",
                       'training_set_txt':"/home/liliana/dataToValidate/Unet100Cases_Data/cases_train_fold_1.txt",
                       'path_to_save_segm':"/home/liliana/Results/UNetUniformSampling32Results/",
                       'path_to_save_metrics': "/home/liliana/Results/UNetUniformSampling32Results/"}


data_dir_test = "/home/liliana/Data/train"
# data_dir_test = "/home/liliana/Brats18TrainingData/"
dataset_test = load_dataset(data_dir_test, testing=True)
# test_cross_validation(dataset_test, testing_folder)
cases_to_validate = "/home/liliana/dataToValidate/UNetUniformSampling32_Data/cases_val_fold_1.txt"
